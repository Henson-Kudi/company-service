...
import Subscription from '../../../../domain/valueObjects/Subscription';
import UpdateCompanySubscriptionDTO from '../../../../domain/dtos/UpdateCompanySubscriptionDTO';

export default class UpdateCompanySubscriptionController implements IContoller {
    constructor(
        private useCase: IUpdateCompanyUseCase<UpdateCompanySubscriptionDTO>
    ) { }
    ...
    async handle(request: IHttpRequest): Promise<IHttpResponse> {
        try {
            ...
            const data: UpdateCompanySubscriptionDTO = {
                subScription: request.body as Subscription
            };
            ...
            await validateJoiSchemaAsync<UpdateCompanySubscriptionDTO>(
